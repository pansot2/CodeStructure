...
public class Info implements Comparable<Info> {
    ...
    public Info(String file, String className, int line, ArrayList<DependancyInfo> dependentOn, ArrayList<DependancyInfo> dependancyOf, FieldParamMethodStructure parent) {
        this.file = file;
